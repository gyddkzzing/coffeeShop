...
<body>
	...
	<div class="container-wrapper">
		<div class="container">
				...
				<tbody>
					...
					<c:forEach var="product" items="${products}">
						<tr>
							...
							<td> <a href= "<c:url value="/admin/productInventory/deleteProduct/${product.product_id}"/>">
									<i class="fas fa-times"></i></a>
								 <a href= "<c:url value="/admin/productInventory/updateProduct/${product.product_id}"/>">
			...
			class="btn btn-warning">Add Menu</a> 
		</div>
	</div>
